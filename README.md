# Event maps from news articles indexed by GDELT

This project pulls news articles related to Human Wildlife Conflicts and other themes from GDELT, enriches them with GKG metadata, runs full-text extraction with a local LLM, and exports map-ready GeoJSONs. It has been used to build maps of HWC events, crop damage events, and avian flu and wild bird death events:

[https://act4d.iitd.ac.in/gdelt-wildlife/](https://act4d.iitd.ac.in/gdelt-wildlife/) 
...
AI-generated code by Cursor Composer 2 Fast and Claude Sonnet 4.6. Guidance and overseeing by Aaditeshwar Seth.